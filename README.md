...
Then, for positive, negative, and neutral scores, there seemed to be only two evident clusters for each: scores = 0 and >0 (=1 and <1 for neutral scores). Example tweets for the two clusters of positive, negative, and neutral scores are provided.
